...
php;
    ...
    {
        $url = isset($tag['url']) ? $tag['url'] : U('Manage/Customer/ajax_upload');
        $name = isset($tag['name']) ? $tag['name'] : 'file_name';
        $word = isset($tag['word']) ? $tag['word'] : '单次最多20个文件,单个文件不能超过10M!';
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        paste: document.body,
         accept: {
             title: 'Images,Files',
             extensions: 'gif,jpg,jpeg,bmp,doc,docx,xls,xlsx,ppt,txt,zip,rar,pdf,mp3',
             mimeTypes: 'text/plain,audio/mpeg,application/x-rar-compressed,application/zip,image/bmp,application/msword,application/pdf,application/vnd.ms-excel,application/vnd.ms-powerpoint'
         },
        ...
        server: "$url",
        fileNumLimit: 20,
        fileSizeLimit: 10 * 1024 * 1024,    // 50 M
